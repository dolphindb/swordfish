...
public:
	...
	inline void setPythonFunction(bool option){ if(option) extraFlag_ |= 128; else extraFlag_ &= ~128;}
	inline bool isPythonFunction() const { return extraFlag_ & 128;}
